...
-- this table and the following function were tweaked by dhausmig

pyramids.loot = {
	{name='farming:beetroot', max = 42},
	{name='farming:blackberry', max = 42},
	{name='farming:blueberries', max = 42},
	{name='farming:cabbage', max = 42},
	{name='farming:carrot', max = 42},
	{name='farming:chili_pepper', max = 42},
	{name='farming:coffee_beans', max = 42},
	{name='farming:corn', max = 42},
	{name='farming:cucumber', max = 42},
	{name='farming:garlic', max = 42},
	{name='farming:grapes', max = 42},
	{name='farming:lettuce', max = 42},
	{name='farming:onion', max = 42},
	{name='farming:pea_pod', max = 42},
	{name='farming:pepper', max = 42},
	{name='farming:pineapple', max = 42},
	{name='farming:potato', max = 42},
	{name='farming:pumpkin', max = 42},
	{name='farming:raspberries', max = 42},
	{name='farming:rhubarb', max = 42},
	{name='farming:soy_pod', max = 42},
	{name='farming:tomato', max = 42},
	{name='farming:vanilla', max = 42},
	{name='default:coal_lump', max = 9},
	{name='default:iron_lump', max = 9},
	{name='default:copper_lump', max = 9},
	{name='default:gold_lump', max = 9},
	{name='default:mese_crystal', max = 9},
	{name='default:diamond', max = 9},
	{name='default:copperblock', max = 3},
	{name='default:steelblock', max = 2},
	{name='default:goldblock', max = 2},
	{name='default:axe_diamond', max = 1},
	{name='default:pick_diamond', max = 1},
	{name='default:shovel_diamond', max = 1},
	{name='default:sword_diamond', max = 1},
	{name='moreores:mithril_ingot', max = 9},
	{name='default:mese', max = 1},
	{name='default:diamondblock', max = 1},
	{name='xtraores:platinum_ingot', max = 12},
	{name='xtraores:palladium_ingot', max = 11},
	{name='xtraores:cobalt_ingot', max = 10},
	{name='xtraores:thorium_ingot', max = 9},
	{name='xtraores:osmium_ingot', max = 8},
	{name='xtraores:rhenium_ingot', max = 7},
	{name='xtraores:vanadium_ingot', max = 6},
	{name='xtraores:rarium_ingot', max = 5},
	{name='xtraores:orichalcum_ingot', max = 4},
	{name='xtraores:titanium_ingot', max = 3},
	{name='xtraores:uranium_ingot', max = 2},
	{name='xtraores:neutronium_ingot', max = 1}
}

function pyramids.register_loot(t)
	if t.name ~= nil then
		t = {t} -- single entry
	end
	for _, loot in ipairs(t) do
		table.insert(pyramids.loot, loot)
	end
end
...
function pyramids.fill_chest(pos)
   minetest.after(2, function()
      ...
      if n and n.name and n.name == 'default:chest' then
         ...
         if math.random(1,8) < 2 then return end  -- fewer empty chests
		 local reps = math.random(1,math.random(3,12))  -- weighted towards lower numbers
         for i=0,reps,1 do
            local stuff = pyramids.loot[math.random(1,math.random(1,#pyramids.loot))] -- weighted towards start of list
