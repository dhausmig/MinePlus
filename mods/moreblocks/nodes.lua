...
local nodes = {
	...
	["trap_sandstone_brick"] = {
		description = S("Trap Sandstone Brick"),
	...
	["trap_desert_sandstone"] = {
		description = S("Trap Desert Sandstone"),
	...
	["trap_desert_sandstone_brick"] = {
		description = S("Trap Desert Sandstone Brick"),
	...
	["trap_silver_sandstone"] = {
		description = S("Trap Silver Sandstone"),
	...
	["trap_silver_sandstone_brick"] = {
		description = S("Trap Silver Sandstone Brick"),
