...
- The table saw can no longer replace items from the player's inventory
  when it is full.
...
- 3 new node shapes in the table saw (thin slabs, available in
