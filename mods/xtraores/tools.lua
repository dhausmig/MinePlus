...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:nickel_ingot', 'group:stick', ''},
		{'', 'group:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:platinum_ingot', 'group:stick', ''},
		{'', 'group:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:palladium_ingot', 'group:stick', ''},
		{'', 'group:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:cobalt_ingot', 'group:stick', ''},
		{'', 'group:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:thorium_ingot', 'xtraores:steel_handle', ''},
		{'', 'xtraores:steel_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:thorium_ingot', 'xtraores:thorium_ingot'},
		{'', 'xtraores:steel_handle', 'xtraores:thorium_ingot'},
		{'xtraores:steel_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:osmium_ingot', 'xtraores:osmium_ingot'},
		{'', 'xtraores:steel_handle', 'xtraores:osmium_ingot'},
		{'xtraores:steel_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:rhenium_ingot', 'xtraores:steel_handle', ''},
		{'', 'xtraores:steel_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:rhenium_ingot', 'xtraores:rhenium_ingot'},
		{'', 'xtraores:steel_handle', 'xtraores:rhenium_ingot'},
		{'xtraores:steel_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:vanadium_ingot', 'xtraores:steel_handle', ''},
		{'', 'xtraores:steel_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:vanadium_ingot', 'xtraores:vanadium_ingot'},
		{'', 'xtraores:steel_handle', 'xtraores:vanadium_ingot'},
		{'xtraores:steel_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:rarium_ingot', 'xtraores:duraglass_handle', ''},
		{'', 'xtraores:duraglass_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:rarium_ingot', 'xtraores:rarium_ingot'},
		{'', 'xtraores:duraglass_handle', 'xtraores:rarium_ingot'},
		{'xtraores:duraglass_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:orichalcum_ingot', 'xtraores:duraglass_handle', ''},
		{'', 'xtraores:duraglass_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:orichalcum_ingot', 'xtraores:orichalcum_ingot'},
		{'', 'xtraores:duraglass_handle', 'xtraores:orichalcum_ingot'},
		{'xtraores:duraglass_handle', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:titanium_ingot', 'xtraores:titanium_ingot'},
		{'', 'xtraores:duraglass_handle', 'xtraores:titanium_ingot'},
		{'xtraores:duraglass_handle', '', ''},
	}
})
...
minetest.register_tool("xtraores:pickaxe_neutronium", {
	description = "".. core.colorize("#68fff6", "Neutronium Pickaxe\n")..
		core.colorize("#FFFFFF", "Mele damage: 24\n")..
		core.colorize("#FFFFFF", "Full punch interval: 0.69\n")..
		core.colorize("#FFFFFF", "range: 6.0\n")..
		core.colorize("#FFFFFF", "Xtraores tool level: 12"),
	inventory_image = "xtraores_pickaxe_neutronium.png",
	range = 6.0,
	tool_capabilities = {
...
minetest.register_craft({
	output = 'xtraores:pickaxe_neutronium',
	recipe = {
...
minetest.register_tool("xtraores:axe_neutronium", {
	description = "".. core.colorize("#68fff6", "Neutronium Axe\n")..
		core.colorize("#FFFFFF", "Mele damage: 24\n")..
		core.colorize("#FFFFFF", "Full punch interval: 0.69\n")..
		core.colorize("#FFFFFF", "range: 6.0\n")..
		core.colorize("#FFFFFF", "Xtraores tool level: 12"),
	inventory_image = "xtraores_axe_neutronium.png",
	range = 6.0,
	tool_capabilities = {
		full_punch_interval = 0.69,
		max_drop_level=1,
...
minetest.register_craft({
	output = 'xtraores:axe_neutronium',
	recipe = {
		{'xtraores:neutronium_ingot', 'xtraores:neutronium_ingot', ''},
		{'xtraores:neutronium_ingot', 'xtraores:duraglass_handle', ''},
		{'', 'xtraores:duraglass_handle', ''},
	}
})

minetest.register_tool("xtraores:sword_neutronium", {
	description = "".. core.colorize("#68fff6", "Neutronium Sword\n")..
		core.colorize("#FFFFFF", "Mele damage: 27\n")..
		core.colorize("#FFFFFF", "Full punch interval: 0.48\n")..
		core.colorize("#FFFFFF", "range: 6.0\n")..
		core.colorize("#FFFFFF", "Xtraores tool level: 12"),
	inventory_image = "xtraores_sword_neutronium.png",
	range = 6.0,
	tool_capabilities = {
		full_punch_interval = 0.48,
		max_drop_level=1,
...
minetest.register_craft({
	output = 'xtraores:sword_neutronium',
	recipe = {
...
minetest.register_tool("xtraores:spear_neutronium", {
	description = "".. core.colorize("#68fff6", "Neutronium Spear\n")..
		core.colorize("#FFFFFF", "Mele damage: 29\n")..
		core.colorize("#FFFFFF", "Full punch interval: 0.75\n")..
		core.colorize("#FFFFFF", "range: 7.5\n")..
		core.colorize("#FFFFFF", "Xtraores tool level: 12"),
	inventory_image = "xtraores_spear_neutronium.png",
	wield_scale = {x=2.0,y=2.0,z=1.0},
	range = 7.5,
	tool_capabilities = {
...
minetest.register_craft({
	output = 'xtraores:spear_neutronium',
	recipe = {
		{'', 'xtraores:neutronium_ingot', 'xtraores:neutronium_ingot'},
		{'', 'xtraores:duraglass_handle', 'xtraores:neutronium_ingot'},
		{'xtraores:duraglass_handle', '', ''},
	}
})

minetest.register_tool("xtraores:shortsword_neutronium", {
	description = "".. core.colorize("#68fff6", "Neutronium Shortsword\n")..
		core.colorize("#FFFFFF", "Mele damage: 25\n")..
		core.colorize("#FFFFFF", "Full punch interval: 0.38\n")..
		core.colorize("#FFFFFF", "range: 4.0\n")..
		core.colorize("#FFFFFF", "Xtraores tool level: 12"),
	inventory_image = "xtraores_shortsword_neutronium.png",
	range = 4.0,
	tool_capabilities = {
...
minetest.register_craft({
	output = 'xtraores:shortsword_neutronium',
	recipe = {
		{'', '', ''},
		{'', '', 'xtraores:neutronium_ingot'},
		{'', 'xtraores:duraglass_handle', ''},
