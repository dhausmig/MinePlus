...
minetest.register_ore({
	ore_type        	= "sheet",
	ore             	= "darkage:tuff",
	wherein         	= {"default:stone", "default:needs_dirt", "default:gravel", "default:coal_ore"},
...
minetest.register_ore({
	ore_type        	= "sheet",
	ore             	= "darkage:ors",
	wherein         	= {"default:stone", "default:dirt", "default:gravel", "default:coal_ore"},
	column_height_max = 8,
	column_height_min = 6,
	y_min            = -200,
	y_max            = 500,
...
local function generate_strati(minp, maxp, seed)
	...
	generate_stratus(data, area, "darkage:dark_marble",
					c_stone,
					stone_and_air_assoc,
