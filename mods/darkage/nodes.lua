...
minetest.register_node("darkage:desert_iron_ore", {
...
minetest.register_node("darkage:dark_marble", {
	description = "Dark Marble",
	tiles = {"darkage_dark_marble.png"},
	is_ground_content = true,
...
minetest.register_node("darkage:limestone", {
