...
function hunger.register_food(name, hunger_change, replace_with_item, poison, heal, sound)
	food[name] = {}
...
function hunger.eat(hp_change, replace_with_item, itemstack, user, pointed_thing)
	...
	local func = hunger.item_eat(def.saturation, def.replace, def.poison, def.healing, def.sound)
	return func(itemstack, user, pointed_thing)
end

function hunger.item_eat(hunger_change, replace_with_item, poison, heal, sound)
	...
	if itemstack:take_item() ~= nil and user ~= nil then
		...
		-- Poison
		if poison then
			hud.change_item(user, "hunger", {text = "hunger_statbar_poison.png"})
			poisonp(1.0, poison, 0, user)
		end
