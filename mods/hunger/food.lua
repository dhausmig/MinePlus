...
--  hunger.register_food(name, hunger_change, replace_with_item, poison, heal, sound)
...
register_food("food:bread", 4)
register_food("food:cheese", 4)
register_food("food:meat", 8)
register_food("food:rat_cooked", 4)
register_food("food:pork_cooked", 8)
register_food("food:chicken_cooked", 6)
register_food("food:chicken_egg_fried", 2)
...
register_food("food:coconut_milk", 1)
register_food("food:raw_coconut", 2)
register_food("food:acorn_muffin", 3)
register_food("food:spruce_nuts", 1)
register_food("food:pine_nuts", 1)
register_food("food:fir_nuts", 1)
