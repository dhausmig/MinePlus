-- Facade Shaper
-- This machine serves the same purpose as the table saw from moreblocks or the milling
...
-- or allow anybody to use them, but disallow the removal of machine itself (like table saw in moreblocks)
...
local function check_material_applicability(material)
	...
	return minetest.registered_nodes[string.gsub(material, "^.*:", "facade:") .. "_centerstone"]
end
