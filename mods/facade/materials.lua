...
facade.register_facade_nodes("default", "coral_skeleton", "default:coral_skeleton", "Coral Skeleton")
...
if minetest.get_modpath("darkage") then
	...
	facade.register_facade_nodes("darkage", "dark_marble", "darkage:dark_marble", "Dark Marble")
	...
	facade.register_facade_nodes("darkage", "limestone", "darkage:limestone", "Limestone")
end
...
if minetest.get_modpath( "technic") then
	facade.register_facade_nodes("technic", "marble", "technic:marble", "White Marble")
	facade.register_facade_nodes("technic", "granite", "technic:granite", "Granite")
end
