...
--			player:set_physics_override(physics)
			playerphysics.add_physics_factor(player, "speed", "3da_speed", physics.speed)
			playerphysics.add_physics_factor(player, "jump", "3da_jump", physics.jump)
			playerphysics.add_physics_factor(player, "gravity", "3da_grav", physics.gravity)
		end
	end
