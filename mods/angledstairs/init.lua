...
minetest.register_craft({
	output ="angledstairs:angled_stair_right" .. subname.." 8",
	recipe = {
...
minetest.register_craft({
	output ="angledstairs:angled_stair_left" .. subname.." 8",
	recipe = {
		{recipeitem, recipeitem, recipeitem},
		{recipeitem, recipeitem, "" },
		{recipeitem, "" , "" },
...
minetest.register_craft({
	output ="angledstairs:angled_slab_left" .. subname.." 16",
	recipe = {
		{recipeitem, "",""},
		{recipeitem, recipeitem, "" },
		{recipeitem, "" , "" },
...
minetest.register_craft({
	output ="angledstairs:angled_slab_right" .. subname.." 16",
	recipe = {
		{"", "", recipeitem},
		{ "",recipeitem, recipeitem },
		{"" , "", recipeitem },
...
angledstairs.register_angled_stair_and_angled_slab("_meseblock", "default:mese",
		{cracky = 1, level = 2},
...
angledstairs.register_angled_stair_and_angled_slab("_grass", "default:dirt_with_grass",
		{cracky = 1, level = 2},
		{"default_grass.png"},
        "Grass Stair",
		"Grass Slab",
