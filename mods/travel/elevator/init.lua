...
local decor_path = minetest.get_modpath("decor")
...
-- Use decor's placeholder if possible.
local placeholder = decor_path and "decor:expansion_placeholder" or "elevator:placeholder"
if decor_path then
    minetest.register_alias("elevator:placeholder", "decor:expansion_placeholder")
else
    -- Placeholder node, in the style of decor.
