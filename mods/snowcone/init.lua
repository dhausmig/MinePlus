...
function snowcone.register_flavor(flavor, def)
	...
	if def.craftitem then
		...
		for _, item in pairs(def.craftitem) do
			if minetest.settings:get_bool("food_utensils") then
				minetest.register_craft({
					output = "snowcone:bucket_syrup_" .. flavor,
					type = "shapeless",
					recipe = {"food:juicer", item, item, item, item, item, "food:sugar", "bucket:bucket_empty", "food:sugar"},
					replacements = {{"food:juicer", "food:juicer"}}
				})
			else
				minetest.register_craft({
					output = "snowcone:bucket_syrup_" .. flavor,
					type = "shapeless",
					recipe = {item, item, item, item, item, item, "food:sugar", "bucket:bucket_empty", "food:sugar"},
				})
			end
		end
	end
...
snowcone.register_flavor("orange", {
	color = "#e67e00",
	craftitem = "orange_tree:orange"
})

snowcone.register_flavor("banana", {
	color = "#e8d664",
	craftitem = "banana_tree:banana"
})
...
snowcone.register_flavor("blueberry", {
	color = "#4918db",
	craftitem = {"group:food_blueberries"}
})
...
snowcone.register_flavor("mint", {
	color = "#40ff40",
	craftitem = "farming:mint_leaf"
})

snowcone.register_flavor("blackberry", {
	color = "#680068",
	craftitem = "farming:blackberry"
})

snowcone.register_flavor("vanilla", {
	color = "#4040bf",
	craftitem = "farming:vanilla"
})

snowcone.register_flavor("cherry", {
	color = "#ff0000",
	craftitem = "group:cherries"
})

snowcone.register_flavor("clementine", {
	color = "#e67e30",
	craftitem = "clementinetree:clementine"
})

snowcone.register_flavor("lemon", {
	color = "#e7e700",
	craftitem = "lemontree:lemon"
})

snowcone.register_flavor("plum", {
	color = "#680082",
	craftitem = "plumtree:plum"
})

snowcone.register_flavor("pomegranate", {
	color = "#ea5937",
	craftitem = "pomegranate:pomegranate"
})

snowcone.register_flavor("coconut", {
	color = "#4040bf",
	craftitem = "food:raw_coconut"
})

snowcone.register_flavor("chocolate", {
	color = "#41220d",
	craftitem = "farming:cocoa_beans"
})

snowcone.register_flavor("coffee", {
	color = "#31190a",
	craftitem = "farming:coffee_beans"
})

snowcone.register_flavor("apple", {
	color = "#ffffbf",
