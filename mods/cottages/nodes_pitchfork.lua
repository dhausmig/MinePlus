...
minetest.register_tool("cottages:pitchfork", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
			fleshy={times={[2]=0.80, [3]=0.40}, uses=20, maxlevel=1, uses=40},
			snappy={times={[2]=0.80, [3]=0.40}, uses=20, maxlevel=1, uses=40},
			hay   ={times={[2]=0.10, [3]=0.10}, uses=20, maxlevel=1, uses=40},
		},
