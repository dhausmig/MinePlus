...
---------------------------------------------------------------------------------------
-- contains:
--  * a bed separated into foot and head reagion so that it can be placed manually; it has
...
minetest.register_node("cottages:shelf", {
		...
		tiles = {"default_wood.png",
                     "default_wood.png",
                     "default_wood.png^[transformFYR90",
                     "default_wood.png^[transformFXR90",
                     "default_wood.png",
                     "default_wood.png"},
		paramtype = "light",
		paramtype2 = "facedir",
...
minetest.register_node("cottages:cabinet", {
		...
		tiles = {"default_wood.png",
                     ...
                     "default_wood.png^[transformFXR90",
                     "default_wood.png",
                     "default_wood.png^(default_wood.png^[transformR90^cottages_cabinet_doors_mask.png^[makealpha:255,0,0)"},
		paramtype = "light",
		paramtype2 = "facedir",
		groups = {snappy=2,choppy=2,oddly_breakable_by_hand=2},
		node_box = {
...
minetest.register_node("cottages:wallmounted_cabinet", {
		...
		tiles = {"default_wood.png",
                     ...
                     "default_wood.png^[transformFXR90",
                     "default_wood.png",
                     "default_wood.png^(default_wood.png^[transformR90^cottages_wallmounted_cabinet_doors_mask.png^[makealpha:255,0,0)"},
		paramtype = "light",
		paramtype2 = "facedir",
		groups = {snappy=2,choppy=2,oddly_breakable_by_hand=2},
		node_box = {
...
--		clicker:set_physics_override(1, 1, 1)
		playerphysics.remove_physics_factor(clicker, "speed", "cottage_speed")
		playerphysics.remove_physics_factor(clicker, "jump", "cottage_jump")
		playerphysics.remove_physics_factor(clicker, "gravity", "cottage_grav")
...
--		clicker:set_physics_override(0, 0, 0)
		playerphysics.add_physics_factor(clicker, "speed", "cottage_speed", 0)
		playerphysics.add_physics_factor(clicker, "jump", "cottage_jump", 0)
		playerphysics.add_physics_factor(clicker, "gravity", "cottage_grav", 0)
