...
-- wolf
	mobs:register_mob("mobs_wolf:wolf", {
		...
		on_rightclick = function(self, clicker)
				if mobs:feed_tame(self, clicker, 2, false, true) then
					if self.food == 0 then
						local mob = minetest.add_entity(self.object:get_pos(), "mobs_wolf:dog")
	...
	mobs:spawn_specific("mobs_wolf:wolf",
		{"default:dirt_with_dry_grass", "default:dirt","default:permafrost_with_moss", "default:snowblock", "default:dirt_with_coniferous_litter"},
		{"air"},
