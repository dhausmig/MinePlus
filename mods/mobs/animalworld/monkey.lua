mobs:register_mob("animalworld:monkey", {
	...
	jump_height = 8,
	pushable = true,
	follow = {"default:apple", "farming:potato", "food:banana_bread", "farming:carrot", "farming:seed_rice", "farming:corn", "farming:wheat", "farming:beans", "farming:barley", "farming:oat", "farming:rye", "food:cheese", "farming:bread", "banana_tree:banana", "farming:cabbage", "farming:lettuce", "farming:melon_slice", "animalworld:locust_roasted"},
	view_range = 15,
	replace_rate = 10,
