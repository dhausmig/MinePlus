...
minetest.register_craft({
	type = 'cooking',
	cooktime = 5,
	output = 'technic:cement_powder',
	recipe = 'darkage:limestone',
})
...
minetest.register_craft({
	output = 'technic:concrete 4',
	recipe = {
		{'technic:rebar','technic:cement_powder','technic:rebar'},
		{'group:sand','bucket:bucket_water','default:gravel'},
		{'technic:rebar','technic:cement_powder','technic:rebar'},
	},
...
minetest.register_craftitem(":technic:cement_powder", {
