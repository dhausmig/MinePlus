...
if minetest.get_modpath("baldcypress") then
	timber_nodenames["baldcypress:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["baldcypress:leaves"]				= true
	end
end
...
if minetest.get_modpath("banana_tree") then
	timber_nodenames["banana_tree:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["banana_tree:leaves"]				= true
		timber_nodenames["banana_tree:banana"]					= true
	end
end
if minetest.get_modpath("cherrytree") then
	...
	if chainsaw_leaves then
		...
		timber_nodenames["cherrytree:cherries"]					= true
	end
end
if minetest.get_modpath("chestnuttree") then
	...
	if chainsaw_leaves then
		...
		timber_nodenames["chestnuttree:bur"]					= true
	end
end
if minetest.get_modpath("clementinetree") then
	...
	if chainsaw_leaves then
		...
		timber_nodenames["clementinetree:clementine"]					= true
	end
end
if minetest.get_modpath("ebony") then
	...
	if chainsaw_leaves then
		...
		timber_nodenames["ebony:persimmon"]					= true
	end
end
	if minetest.get_modpath("hollytree") then
	timber_nodenames["hollytree:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["hollytree:leaves"]				= true
	end
end
if minetest.get_modpath("jacaranda") then
	timber_nodenames["jacaranda:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["jacaranda:leaves"]				= true
	end
end
...
if minetest.get_modpath("lemontree") then
	...
	if chainsaw_leaves then
		...
		timber_nodenames["lemontree:lemon"]					= true
	end
end
...
if minetest.get_modpath("maple") then
	timber_nodenames["maple:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["maple:leaves"]				= true
	end
end
if minetest.get_modpath("metasequoia") then
	timber_nodenames["metasequoia:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["metasequoia:leaves"]				= true
	end
end
if minetest.get_modpath("orange_tree") then
	timber_nodenames["orange_tree:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["orange_tree:leaves"]				= true
		timber_nodenames["orange_tree:orange"]					= true
	end
end
if minetest.get_modpath("plumtree") then
	timber_nodenames["plumtree:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["plumtree:leaves"]				= true
		timber_nodenames["plumtree:plum"]					= true
	end
end
if minetest.get_modpath("pomegranate") then
	timber_nodenames["pomegranate:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["pomegranate:leaves"]				= true
		timber_nodenames["pomegranate:pomegranate"]					= true
	end
end
if minetest.get_modpath("redoak") then
	timber_nodenames["redoak:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["redoak:leaves"]				= true
		timber_nodenames["redoak:acorn"]					= true
	end
end
if minetest.get_modpath("willow") then
	timber_nodenames["willow:trunk"]						= true
	if chainsaw_leaves then
		timber_nodenames["willow:leaves"]				= true
	end
end
...
if minetest.get_modpath("ethereal") then
	...
	if chainsaw_leaves then
		...
		-- some extras
		timber_nodenames["ethereal:olive_leaves"]  = true
		timber_nodenames["ethereal:olive"]         = true
		timber_nodenames["ethereal:lemon_leaves"]  = true
		timber_nodenames["ethereal:lemon"]         = true
	end
end
