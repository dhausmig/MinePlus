...
minetest.register_craft({
	output = "default:plastic_sheet 9",
	recipe = {
...
minetest.register_craft({
	output = "technic:plastic_siding_1_thin 4",
	recipe = {
...
minetest.register_craft({
	output = "technic:plastic_siding_2_thin 2",
	recipe = {
		{ "technic:plastic_siding_2"},
...
minetest.register_craft({
	output = "technic:plastic_siding_3_thin 2",
	recipe = {
		{ "technic:plastic_siding_3"},
	},
})
...
minetest.register_craft({
	output = "technic:plastic_clean 4",
	recipe = {
		{ "technic:plastic_bricks", "technic:plastic_bricks"},
		{ "technic:plastic_bricks", "technic:plastic_bricks"},
	},
})
...
minetest.register_craft({
	output = "technic:plastic_clean",
	recipe = {
		{ "technic:plastic_cross"},
	},
})

minetest.register_craft({
	output = "technic:plastic_waves 3",
	recipe = {
		{ "", "technic:plastic_clean", ""},
		{ "technic:plastic_clean", "", "technic:plastic_clean"},
		{ "", "", ""},
