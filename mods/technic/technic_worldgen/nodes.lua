...
-- Intllib
--local S = minetest.get_translator and minetest.get_translator("technic_worldgen") or
--		dofile(technic_worldgen.path .. "/intllib.lua")

--technic_worldgen.intllib = S
local S = function(s) return s end

minetest.register_node( ":technic:uranium_ore", {
...
minetest.register_node( ":technic:chromium_ore", {
...
minetest.register_node( ":technic:zinc_ore", {
...
minetest.register_node( ":technic:lead_ore", {
...
minetest.register_node( ":technic:sulfur_ore", {
...
minetest.register_alias("technic:diamond_ore", "default:diamond_ore")
--]]
