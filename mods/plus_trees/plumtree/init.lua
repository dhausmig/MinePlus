...
doors.register_fencegate(":doors:gate_plumtree", {
	description = S("Plum Wood Fence Gate"),
...
default.register_fence("plumtree:fence",{
    description = "Plumtree Wood Fence",
    texture = "plumtree_wood.png",
    inventory_image = "default_fence_overlay.png^plumtree_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_overlay.png^plumtree_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    material = "plumtree:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
default.register_fence_rail("plumtree:fence_rail", {
    description = "Plumtree Wood Fence Rail",
    texture = "plumtree_wood.png",
    inventory_image = "default_fence_rail_overlay.png^plumtree_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_rail_overlay.png^plumtree_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    material = "plumtree:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
if minetest.get_modpath("lumberjack") and minetest.global_exists("lumberjack") then
	lumberjack.register_tree("plumtree:trunk", "plumtree:sapling", 1, 3)
end

-- Shelves

vessels.register_shelf("plumtree:plum_shelf", {
	description = "Plum Vessels Shelf",
	tiles = {"plumtree_wood.png", "plumtree_wood.png", "plumtree_wood.png^[transformR90",
		"plumtree_wood.png^[transformR90", "vessels_shelf.png", "vessels_shelf.png"},
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
	recipe = {
		{"plumtree:wood", "plumtree:wood", "plumtree:wood"},
		{"group:vessel", "group:vessel", "group:vessel"},
		{"plumtree:wood", "plumtree:wood", "plumtree:wood"},
	},
})

default.register_bookshelf("plumtree:plum", {
	description = "Plum Bookshelf",
	tiles = {"plumtree_wood.png", "plumtree_wood.png", "plumtree_wood.png^[transformR90",
		"plumtree_wood.png^[transformR90", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'plumtree:plum_bookshelf',
	recipe = {
		{'plumtree:wood', 'plumtree:wood', 'plumtree:wood'},
...
if minetest.get_modpath("stairs") ~= nil then
	stairs.register_stair_and_slab(
		...
		"plumtree_trunk_top.png",
		"plumtree_trunk.png"},
		S("Plum Tree Trunk Stair"),
		S("Plum Tree Trunk Slab"),
