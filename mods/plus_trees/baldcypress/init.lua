...
doors.register_fencegate(":doors:gate_baldcypress", {
	description = S("Baldcypress Fence Gate"),
...
default.register_fence("baldcypress:fence", {
    description = "Baldcypress Wood Fence",
    texture = "baldcypress_wood.png",
    inventory_image = "default_fence_overlay.png^baldcypress_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_overlay.png^baldcypress_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    material = "baldcypress:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
default.register_fence_rail("baldcypress:fence_rail", {
    description = "Baldcypress Wood Fence Rail",
    texture = "baldcypress_wood.png",
    inventory_image = "default_fence_rail_overlay.png^baldcypress_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_rail_overlay.png^baldcypress_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    material = "baldcypress:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
if minetest.get_modpath("lumberjack") and minetest.global_exists("lumberjack") then
	lumberjack.register_tree("baldcypress:trunk", "baldcypress:sapling", 1, 3)
end

-- Shelves

vessels.register_shelf("baldcypress:vessel_shelf", {
	description = "Baldcypress Vessels Shelf",
	tiles = {"baldcypress_wood.png^[transformR90", "baldcypress_wood.png^[transformR90", "baldcypress_wood.png",
		"baldcypress_wood.png", "vessels_shelf.png", "vessels_shelf.png"},
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
	recipe = {
		{"baldcypress:wood", "baldcypress:wood", "baldcypress:wood"},
		{"group:vessel", "group:vessel", "group:vessel"},
		{"baldcypress:wood", "baldcypress:wood", "baldcypress:wood"},
	},
})

default.register_bookshelf("baldcypress:wood", {
	description = "Baldcypress Bookshelf",
	tiles = {"baldcypress_wood.png^[transformR90", "baldcypress_wood.png^[transformR90", "baldcypress_wood.png",
		"baldcypress_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'baldcypress:wood_bookshelf',
	recipe = {
		{'baldcypress:wood', 'baldcypress:wood', 'baldcypress:wood'},
...
if minetest.get_modpath("stairs") ~= nil then
	stairs.register_stair_and_slab(
		...
		"baldcypress_trunk_top.png",
		"baldcypress_trunk.png"},
		S("Bald Cypress Trunk Stair"),
		S("Bald Cypress Trunk Slab"),
...
if minetest.get_modpath("moreblocks") then
	...
	stairsplus:register_all(
		...
		"baldcypress:trunk",
		{
			...
			description = S("baldcypress Trunk"),
			drop = "baldcypress_trunk",
		}
	)
	...
	stairsplus:register_all(
		...
		"baldcypress:wood",
		{
			...
			tiles = { "baldcypress_wood.png" },
			description = S("Baldcypress wood"),
			drop = "baldcypress_wood",
		}
	)
end
