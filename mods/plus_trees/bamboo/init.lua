...
default.register_fence("bamboo:fence", {
    description = "Bamboo Wood Fence",
    texture = "bamboo_floor.png",
    inventory_image = "default_fence_overlay.png^bamboo_floor.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_overlay.png^bamboo_floor.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    material = "bamboo:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
default.register_fence_rail("bamboo:fence_rail", {
    description = "Bamboo Wood Fence Rail",
    texture = "bamboo_floor.png",
    inventory_image = "default_fence_rail_overlay.png^bamboo_floor.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_rail_overlay.png^bamboo_floor.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    material = "bamboo:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
vessels.register_shelf("bamboo:bamboo_shelf", {
	description = "Bamboo Vessels Shelf",
	tiles = {"bamboo_floor.png^[transformR90", "bamboo_floor.png^[transformR90", "bamboo_floor.png",
		"bamboo_floor.png", "vessels_shelf.png", "vessels_shelf.png"},
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
	recipe = {
		{"bamboo:wood", "bamboo:wood", "bamboo:wood"},
		{"group:vessel", "group:vessel", "group:vessel"},
		{"bamboo:wood", "bamboo:wood", "bamboo:wood"},
	},
})

default.register_bookshelf("bamboo:bamboo", {
	description = "Bamboo Bookshelf",
	tiles = {"bamboo_floor.png^[transformR90", "bamboo_floor.png^[transformR90", "bamboo_floor.png",
		"bamboo_floor.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'bamboo:bamboo_bookshelf',
	recipe = {
		{'bamboo:wood', 'bamboo:wood', 'bamboo:wood'},
