...
doors.register_fencegate(":doors:gate_ebony", {
...
default.register_fence("ebony:fence", {
    description = "Ebony Wood Fence",
    texture = "ebony_wood.png",
    inventory_image = "default_fence_overlay.png^ebony_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_overlay.png^ebony_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    material = "ebony:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
default.register_fence_rail("ebony:fence_rail", {
    description = "Ebony Wood Fence Rail",
    texture = "ebony_wood.png",
    inventory_image = "default_fence_rail_overlay.png^ebony_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_rail_overlay.png^ebony_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    material = "ebony:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
if minetest.get_modpath("lumberjack") and minetest.global_exists("lumberjack") then
	lumberjack.register_tree("ebony:trunk", "ebony_tree:sapling", 1, 3)
end

-- Shelves

vessels.register_shelf("ebony:ebony_shelf", {
	description = "Ebony Vessels Shelf",
	tiles = {"ebony_wood.png^[transformR90", "ebony_wood.png^[transformR90", "ebony_wood.png",
		"ebony_wood.png", "vessels_shelf.png", "vessels_shelf.png"},
...
default.register_bookshelf("ebony:ebony", {
	description = "Ebony Bookshelf",
	tiles = {"ebony_wood.png^[transformR90", "ebony_wood.png^[transformR90", "ebony_wood.png",
		"ebony_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'ebony:ebony_bookshelf',
	recipe = {
		{'ebony:wood', 'ebony:wood', 'ebony:wood'},
