...
minetest.register_node("cherrytree:cherries", {
	...
	groups = {fleshy = 3, dig_immediate = 3, flammable = 2,
		leafdecay = 3, leafdecay_drop = 1, cherries = 1},
...
doors.register_fencegate(":doors:gate_cherrytree", {
	description = S("Cherry Wood Fence Gate"),
...
default.register_fence("cherrytree:fence", {
...
default.register_fence_rail("cherrytree:fence_rail", {
...
if minetest.get_modpath("lumberjack") and minetest.global_exists("lumberjack") then
	lumberjack.register_tree("cherrytree:banana_trunk", "cherrytree:sapling", 1, 3)
end

-- Shelves

vessels.register_shelf("cherrytree:cherry_shelf", {
	description = "Cherrywood Vessels Shelf",
	tiles = {"cherrytree_wood.png^[transformR90", "cherrytree_wood.png^[transformR90", "cherrytree_wood.png",
		"cherrytree_wood.png", "vessels_shelf.png", "vessels_shelf.png"},
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
	recipe = {
		{"cherrytree:wood", "cherrytree:wood", "cherrytree:wood"},
		{"group:vessel", "group:vessel", "group:vessel"},
		{"cherrytree:wood", "cherrytree:wood", "cherrytree:wood"},
	},
})

default.register_bookshelf("cherrytree:cherry", {
	description = "CherryWood Bookshelf",
	tiles = {"cherrytree_wood.png^[transformR90", "cherrytree_wood.png^[transformR90", "cherrytree_wood.png",
		"cherrytree_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'cherrytree:cherry_bookshelf',
	recipe = {
		{'cherrytree:wood', 'cherrytree:wood', 'cherrytree:wood'},
...
if minetest.get_modpath("stairs") ~= nil then
	stairs.register_stair_and_slab(
		...
		"cherrytree_trunk_top.png",
		"cherrytree_trunk.png"},
		S("Cherry Tree Trunk Stair"),
		S("Cherry Tree Trunk Slab"),
