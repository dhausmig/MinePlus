...
doors.register_fencegate(":doors:gate_pomegranate", {
	description = S("Pomegranate Wood Fence Gate"),
...
default.register_fence("pomegranate:fence", {
    description = "Pomegranate Wood Fence",
    texture = "pomegranate_wood.png",
    inventory_image = "default_fence_overlay.png^pomegranate_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_overlay.png^pomegranate_wood.png^" ..
        "default_fence_overlay.png^[makealpha:255,126,126",
    material = "pomegranate:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
default.register_fence_rail("pomegranate:fence_rail", {
    description = "Pomegranate Wood Fence Rail",
    texture = "pomegranate_wood.png",
    inventory_image = "default_fence_rail_overlay.png^pomegranate_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    wield_image = "default_fence_rail_overlay.png^pomegranate_wood.png^" ..
        "default_fence_rail_overlay.png^[makealpha:255,126,126",
    material = "pomegranate:wood",
    groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
    sounds = default.node_sound_wood_defaults()
...
if minetest.get_modpath("lumberjack") and minetest.global_exists("lumberjack") then
	lumberjack.register_tree("pomegranate:trunk", "pomegranate:sapling", 1, 3)
end

-- Shelves

vessels.register_shelf("pomegranate:pomegranate_shelf", {
	description = "Pomegranate Vessels Shelf",
	tiles = {"pomegranate_wood.png^[transformR90", "pomegranate_wood.png^[transformR90", "pomegranate_wood.png",
		"pomegranate_wood.png", "vessels_shelf.png", "vessels_shelf.png"},
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
	recipe = {
		{"pomegranate:wood", "pomegranate:wood", "pomegranate:wood"},
		{"group:vessel", "group:vessel", "group:vessel"},
		{"pomegranate:wood", "pomegranate:wood", "pomegranate:wood"},
	},
})

default.register_bookshelf("pomegranate:pomegranate", {
	description = "Pomegranate Bookshelf",
	tiles = {"pomegranate_wood.png^[transformR90", "pomegranate_wood.png^[transformR90", "pomegranate_wood.png",
		"pomegranate_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_craft({
	output = 'pomegranate:pomegranate_bookshelf',
	recipe = {
		{'pomegranate:wood', 'pomegranate:wood', 'pomegranate:wood'},
...
if minetest.get_modpath("stairs") ~= nil then
	stairs.register_stair_and_slab(
		...
		"pomegranate_trunk_top.png",
		"pomegranate_trunk.png"},
		S("Pomegranate Trunk Stair"),
		S("Pomegranate Trunk Slab"),
