...
handle_schematics.enable_use_dirt_as_placeholder = function()
	local fill_nodes = {"default:stone","default:coal_ore","default:iron_ore",
		"default:copper_ore","default:mese_ore","default:diamond_ore",
		"default:gold_ore","default:tin_ore",
