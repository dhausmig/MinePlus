...
replacements_group['roof'].construct_roof_type_list = function()
	...
	for i,v in ipairs( roofs ) do
		replacements_group['roof'].add_material( {
			'decor:shingle_side_'..v,
			'decor:shingles_'..v,
			'',
			'decor:shingles_'..v,
			'decor:shingle_inner_corner_'..v,
			'decor:shingle_outer_corner_'..v,
			} );
	end

	replacements_group['roof'].data[ 'decor:shingle_side_glass'  ][2] = 'decor:skylight';
	replacements_group['roof'].data[ 'decor:shingle_side_glass'  ][4] = 'decor:skylight';
	replacements_group['roof'].data[ 'decor:shingle_side_asphalt'][3] = 'streets:asphalt';
