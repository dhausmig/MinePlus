...
ADD_RCC({'decor:beer_mug',             50,  1,  2, tavern=5, inn=3, ship=1});
ADD_RCC({'decor:book_blue',            50,  1,  2, church=1, library=1, chest_private=1, ship=1});
ADD_RCC({'decor:book_red',             50,  1,  2, church=1, library=1, chest_private=1, ship=1});
ADD_RCC({'decor:book_green',           50,  1,  2, church=1, library=1, chest_private=1, ship=1});
ADD_RCC({'decor:bottle_brown',         50,  1,  2, tavern=3, inn=3, chest_private=1, ship=1});
ADD_RCC({'decor:bottle_green',         50,  1,  2, tavern=3, inn=3, chest_private=1, ship=1});
ADD_RCC({'decor:calendar',             50,  1,  1, church=1, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1});
ADD_RCC({"decor:candle",               50,  2,  1, church=2, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1 });
ADD_RCC({"decor:candle_thin",          50,  2,  1, church=1, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1 });
ADD_RCC({"decor:copper_pans",          80,  1,  1, chest_work=1, ship=1 });
ADD_RCC({"decor:dardboard",            50,  1,  1, tavern=1});
ADD_RCC({"default:oil_extract",          80,  1,  3, church=1, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1 });
ADD_RCC({"decor:oil_lamp",             50,  2,  1, church=1, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1 });
ADD_RCC({"decor:torch_wall",           50,  2,  1, church=1, library=1, chest_private=1, chest_work=1, chest_storage=1, ship=1 });
...
ADD_RCC({"food:coconut_milk",         80,  5,  2, tavern=1, inn=1, ship=1 });
ADD_RCC({"food:raw_coconut",          80,  5,  2, tavern=1, inn=1, ship=1 });
ADD_RCC({"food:pine_nuts",            80, 99,  1, tavern=1, inn=1, chest_storage=3, ship=1 });
ADD_RCC({"food:spruce_nuts",          80, 99,  1, tavern=1, inn=1, chest_storage=3, ship=1 });
