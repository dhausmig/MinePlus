...
--	[0]  = {P2_IGNORE, "air"},
	...
	[14] = {P2_IGNORE, "default:gold_ore"},
	[15] = {P2_IGNORE, "default:iron_ore"},
	[16] = {P2_IGNORE, "default:coal_ore"},
	...
	[21] = {P2_IGNORE, "default:copper_ore"}, -- Lapis Lazuli Ore
...
-- 36: piston extension
	...
	[56] = {P2_IGNORE, "default:diamond_ore"},
	...
	[129]= {P2_IGNORE, "default:mese_ore"},
...
--	# Reference: https://github.com/Jeija/minetest-mod-mesecons/blob/master/mesecons_alias/init.lua
	...
	[73] = {P2_IGNORE, "default:mese_ore"},
	[74] = {P2_IGNORE, "default:mese_ore"},
