...
function decor.register_furnace(name, furnacedef)
	...
	decor.register(name, def)
	decor.register(n_active, def_active)

	local nname, name_active = "decor:"..name, "decor:"..n_active
