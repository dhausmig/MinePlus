...
-- Digtron Builder Tool settings
setting("bool", "builder_tool_verbose_read", false, "Builder Tool can display a message when reading a builder.")
setting("bool", "builder_tool_verbose_write", false, "Builder Tool can display a message when setting a builder.")
