...
local function add_ore(modname, description, mineral_name, oredef)
	...
	if oredef.makes.ore then
		minetest.register_node(modname .. ":" .. mineral_name .. "_ore", {
	...
	oredef.oredef.ore = modname .. ":" .. mineral_name .. "_ore"
...
--[[			hoe = {
			...
			sword = {
				...
				choppy = {times = {[3] = 0.65}, uses = 500, maxlevel= 0}
			}
		},
...
if default_tin then
	minetest.register_alias("moreores:tin_ore", "default:tin_ore")
