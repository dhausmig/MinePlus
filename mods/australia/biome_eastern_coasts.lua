...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_eastern_coasts" ) end
...
local fruit = nil
local limbs = false
local trunk = "australia:coast_banksia_trunk"
...
local fruit = nil
local limbs = false
local trunk = "australia:illawarra_flame_trunk"
...
local fruit = nil
local limbs = false
local trunk = "australia:lemon_myrtle_trunk"
...
local limbs = nil
local trunk = "australia:macadamia_trunk"
...
local limbs = nil
local trunk = "australia:moreton_bay_fig_trunk"
local leaves = "australia:moreton_bay_fig_leaves"
for r = 11,max_r do
	local schem = aus.generate_giant_tree_schematic(2, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local fruit = nil
local limbs = nil
local trunk = "australia:paperbark_trunk"
...
local fruit = nil
local limbs = nil
local trunk = "australia:scribbly_gum_trunk"
