...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_central_australia" ) end
...
local fruit = nil
local limbs = nil
local trunk = "australia:desert_oak_trunk"
...
local fruit = nil
local limbs = false
local trunk = "australia:wirewood_trunk"
...
local fruit = nil
local limbs = nil
local trunk = "australia:sugar_gum_trunk"
