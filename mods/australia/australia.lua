...
-- mods/australia/australia.lua
-- (used to be mods/australia/init.lua)
if minetest.settings:get_bool("log_files") then minetest.log("australia/australia" ) end

-- MOD: australia
-- See README.md for licensing and other information.
-- Designed for valleys mapgen in Minetest 0.4.14, but will work with mgv5,
-- mgv7, flat and fractal with limitations.
-- modified by dhausmig to NOT delete other biomes
