...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_tasmania" ) end
...
local max_r = 5
local fruit = nil
local trunk = "australia:celery_top_pine_trunk"
local leaves = "australia:celery_top_pine_leaves"
for r = 4,max_r do
	local schem = aus.generate_conifer_schematic(5, 4, trunk, leaves, fruit)
...
local fruit = nil
local limbs = nil
local trunk = "australia:huon_pine_trunk"
