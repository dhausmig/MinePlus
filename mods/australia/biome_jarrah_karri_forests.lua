...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_jarrah_karri_forests" ) end
...
local fruit = nil
local limbs = false
local trunk = "australia:bull_banksia_trunk"
...
local fruit = nil
local limbs = nil
local trunk = "australia:jarrah_trunk"
local leaves = "australia:jarrah_leaves"
for r = 8,max_r do
	local schem = aus.generate_giant_tree_schematic(8, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local fruit = nil
local limbs = nil
local trunk = "australia:karri_trunk"
local leaves = "australia:karri_leaves"
for r = 10,max_r do
	local schem = aus.generate_giant_tree_schematic(20, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local fruit = nil
local limbs = nil
local trunk = "australia:marri_trunk"
local leaves = "australia:marri_leaves"
for r = 8,max_r do
	local schem = aus.generate_big_tree_schematic(8, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local max_r = 3
local fruit = nil
local trunk = "australia:rottnest_island_pine_trunk"
...
local fruit = nil
local limbs = nil
local trunk = "australia:swamp_paperbark_trunk"
