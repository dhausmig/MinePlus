...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_murray_darling_basin" ) end
...
local fruit = nil
local limbs = nil
local trunk = "australia:black_box_trunk"
local leaves = "australia:black_box_leaves"
for r = 6,max_r do
	local schem = aus.generate_big_tree_schematic(4, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
