...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_gulf_of_carpentaria" ) end
...
local fruit = nil
local limbs = nil
local trunk = "australia:cloncurry_box_trunk"
