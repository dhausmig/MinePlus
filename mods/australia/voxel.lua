...
if minetest.settings:get_bool("log_files") then minetest.log("australia/voxel" ) end
...
local nodes = {
	...
	{"copper", "default:copper_ore"},
	{"diamond", "default:diamond_ore"},
	{"gold", "default:gold_ore"},
	{"iron", "default:iron_ore"},
