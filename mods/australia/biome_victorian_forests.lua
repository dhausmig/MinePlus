...
if minetest.settings:get_bool("log_files") then minetest.log("australia/biome_victorian_forests" ) end
...
minetest.register_decoration({
	...
	schematic = {
		...
		data = {
			...
			{name = "air", prob = 0},
			{name = "air", prob = 0},
			{name = "australia:white_box_trunk", param2 = 12, prob = 191},
			{name = "australia:white_box_trunk", param2 = 12},
			{name = "australia:white_box_trunk", param2 = 12, prob = 127},
			{name = "air", prob = 0},
			{name = "flowers:mushroom_brown", prob = 63},
			{name = "air", prob = 0},
		},
...
local fruit = nil
local limbs = nil
local trunk = "australia:swamp_gum_trunk"
local leaves = "australia:swamp_gum_leaves"
for r = 6,max_r do
	local schem = aus.generate_giant_tree_schematic(26, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local fruit = nil
local limbs = nil
local trunk = "australia:tasmanian_myrtle_trunk"
local leaves = "australia:tasmanian_myrtle_leaves"
for r = 6,max_r do
	local schem = aus.generate_big_tree_schematic(6, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
...
local fruit = nil
local limbs = nil
local trunk = "australia:white_box_trunk"
local leaves = "australia:white_box_leaves"
for r = 6,max_r do
	local schem = aus.generate_tree_schematic(5, {x=r, y=ht, z=r}, trunk, leaves, fruit, limbs)
