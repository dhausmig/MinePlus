...
dhausmig (CC BY-SA 3.0):
  default_log.mts (renamed Shara RedCat's apple_log)
  default_tree.mts (based on paramat's apple_tree)
  default_tree_from_sapling.mts (based on paramat's apple_tree_from_sapling)
