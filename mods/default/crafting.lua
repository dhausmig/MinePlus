...
minetest.register_craft({
	output = 'default:acacia_bookshelf',
	recipe = {
...
minetest.register_craft({
	output = 'default:aspen_bookshelf',
	recipe = {
...
minetest.register_craft({
	output = 'default:jungle_bookshelf',
	recipe = {
...
-- which is also the order of wood color darkness:
