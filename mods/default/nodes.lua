...
default:bookshelf
default:acacia_bookshelf
default:aspen_bookshelf
default:jungle_bookshelf
default:pine_bookshelf
...
minetest.register_node("default:leaves", {
	description = S("Default Tree Leaves"),
...
minetest.register_node("default:mese_ore", {
...
minetest.register_node("default:diamond_ore", {
...
-- API to register bookshelves

function default.register_bookshelf(name, d)
	if not name:find(":") then
		name = "default:" .. name
	end
	if not name:find("bookshelf") then
		name = name .. "_bookshelf"
	end
	local def = table.copy(d)
	if not def.groups then def.groups = {bookshelf = 1, oddly_breakable_by_hand = 2} end
	...
	def.allow_metadata_inventory_put = function(pos, listname, index, stack)
...
default.register_bookshelf("default:bookshelf",
{
...
default.register_bookshelf("default:acacia", {
	description = "Acacia Bookshelf",
	tiles = {"default_fence_acacia_wood.png", "default_fence_acacia_wood.png", "default_acacia_wood.png",
		"default_acacia_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

default.register_bookshelf("default:aspen", {
	description = "Aspen Bookshelf",
	tiles = {"default_fence_aspen_wood.png", "default_fence_aspen_wood.png", "default_aspen_wood.png",
		"default_aspen_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

default.register_bookshelf("default:jungle", {
	description = "Junglewood Bookshelf",
	tiles = {"default_fence_junglewood.png", "default_fence_junglewood.png", "default_junglewood.png",
		"default_junglewood.png", "default_bookshelf.png", "default_bookshelf.png"},
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
})

default.register_bookshelf("default:pine", {
	description = "Pine Bookshelf",
	tiles = {"default_fence_pine_wood.png", "default_fence_pine_wood.png", "default_pine_wood.png",
		"default_pine_wood.png", "default_bookshelf.png", "default_bookshelf.png"},
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
