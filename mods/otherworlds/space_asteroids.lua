if otherworlds.settings.space_asteroids.enable then
	...
	minetest.register_on_generated(otherworlds.asteroids.create_on_generated(YMIN, YMAX, {
		...
		c_ironore = minetest.get_content_id("default:iron_ore"),
		c_copperore = minetest.get_content_id("default:copper_ore"),
		c_goldore = minetest.get_content_id("default:gold_ore"),
		c_diamondore = minetest.get_content_id("default:diamond_ore"),
		c_meseore = minetest.get_content_id("default:mese_ore"),
		...
		c_titaniumore = minetest.get_content_id("xtraores:titanium_ore"),
	}))
