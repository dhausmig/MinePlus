...
for i in ipairs(moretrees.treelist) do
	...
	if treename ~= "jungletree"  -- the default game provides jungle tree and pine trunk/planks nodes.
		...
		local woodblock = "moretrees:"..treename.."_wood"
		local woodpic = "moretrees_"..treename.."_wood.png"
		...
		minetest.register_node("moretrees:"..treename.."_wood", {
		...
		minetest.register_alias("moretrees:"..treename.."_planks", "moretrees:"..treename.."_wood")
...
-- Door and/or Gate
		doors.register_fencegate(":doors:gate_" .. treename, {
			description = S(treedesc .. " Wood Fence Gate"),
			texture = woodpic,
			material = "moretrees:"..treename.."_wood",
...
-- Fence
		...
		default.register_fence("moretrees:"..treename.."_fence", {
			...
			texture = woodpic,
			inventory_image = "default_fence_overlay.png^moretrees_"..treename.."_wood.png^" ..
				"default_fence_overlay.png^[makealpha:255,126,126",
			wield_image = "default_fence_overlay.png^moretrees_"..treename.."_wood.png^" ..
				"default_fence_overlay.png^[makealpha:255,126,126",
			material = woodblock,
			groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
			sounds = default.node_sound_wood_defaults()
		...
		default.register_fence_rail("moretrees:"..treename.."_fence_rail", {
			...
			texture = woodpic,
			inventory_image = "default_fence_rail_overlay.png^moretrees_"..treename.."_wood.png^" ..
				"default_fence_rail_overlay.png^[makealpha:255,126,126",
			wield_image = "default_fence_rail_overlay.png^moretrees_"..treename.."_wood.png^" ..
				"default_fence_rail_overlay.png^[makealpha:255,126,126",
			material = woodblock,
			groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
			sounds = default.node_sound_wood_defaults()
...
-- Shelves
		...
		vessels.register_shelf("moretrees:"..treename.."_shelf", {
			description = treedesc.." Vessels Shelf",
			tiles = {woodpic.."^[transformR90", woodpic.."^[transformR90", woodpic,
				woodpic, "vessels_shelf.png", "vessels_shelf.png"},
		...
		default.register_bookshelf("moretrees:"..treename, {
			description = treedesc.." Bookshelf",
			tiles = {woodpic.."^[transformR90", woodpic.."^[transformR90", woodpic,
				woodpic, "default_bookshelf.png", "default_bookshelf.png"},
			groups = {bookshelf = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
			sounds = default.node_sound_wood_defaults(),
		})

		minetest.register_craft({
			output = "moretrees:"..treename.."_bookshelf",
			recipe = {
				{"moretrees:"..treename.."_wood", "moretrees:"..treename.."_wood", "moretrees:"..treename.."_wood"},
	...
	--			stairsplus:register_all(modname, subname, recipeitem, {fields})
				...
				stairsplus:register_all(
					"moretrees",
					treename.."_wood",
					"moretrees:"..treename.."_wood",
					{
						groups = { snappy=1, choppy=2, oddly_breakable_by_hand=2, flammable=3, not_in_creative_inventory=1 },
						tiles = { woodpic },
						description = S(treedesc.." wood"),
						drop = treename.."_wood",
					}
				)
	...
	if fruit then
		...
		if fruit == "acorn" then
			minetest.register_node(fruitname, {
				...
				groups = {fleshy=3,dig_immediate=3,flammable=2, attached_node=1, leafdecay = 1, leafdecay_drop = 1, acorn = 1},
				sounds = default.node_sound_defaults(),
			})
		else
			minetest.register_node(fruitname, {
...
minetest.register_alias("moretrees:jungletree_wood",			"default:junglewood")
...
minetest.register_alias("moretrees:acacia_wood",				"default:acacia_wood")
...
minetest.register_alias("moretrees:pine_wood",				"moretrees:cedar_wood")
