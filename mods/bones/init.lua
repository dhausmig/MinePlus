...
minetest.register_on_dieplayer(function(player)
   local die_x = tostring(math.floor(player:get_pos().x))
	local die_y = tostring(math.floor(player:get_pos().y))
	local die_z = tostring(math.floor(player:get_pos().z))
	minetest.chat_send_player(player:get_player_name(), "You died at "..die_x..","..die_y..","..die_z)
end)
