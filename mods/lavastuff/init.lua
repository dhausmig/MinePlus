...
minetest.register_node("lavastuff:hot_stone", {
    description = "Hot Stone",
	tiles = {"default_stone.png^lavastuff_hot_stone.png"},
	groups = {cracky = 2},
...
minetest.register_craft({
    type = "cooking",
    output = "lavastuff:hot_stone",
    recipe = "default:stone",
	cooktime = 7,
})

-- this from craftable_lava mod
minetest.register_craft({
    output = "bucket:bucket_lava",
	recipe = {{"lavastuff:hot_stone", "lavastuff:hot_stone", "lavastuff:hot_stone"},
    {"lavastuff:hot_stone", "bucket:bucket_empty", "lavastuff:hot_stone"},
    {"lavastuff:hot_stone", "lavastuff:hot_stone", "lavastuff:hot_stone"}},
})
