...
angledglass.register_glass("quartz_block_glass", "quartz:block", "default:glass",
		{choppy = 2, oddly_breakable_by_hand = 2, flammable = 3, wood = 1},
		{"default_glass.png", "quartz_block.png"},
		"Quartz Block Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("quartz_block_obsidian_glass", "quartz:block", "default:obsidian_glass",
		{choppy = 2, oddly_breakable_by_hand = 2, flammable = 3, wood = 1},
