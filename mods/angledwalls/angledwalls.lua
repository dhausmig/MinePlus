...
function angledwalls.register_angled_wall(subname, recipeitem, groups, images, description, sounds)
	groups.angledwall = 1
minetest.register_node("angledwalls:angled_wall_" .. subname, {
...
minetest.register_craft({
	output = "angledwalls:angled_wall_" .. subname.." 4",
	recipe = {
		{recipeitem, "", ""},
		{"", recipeitem, ""},
		{"", "", recipeitem}
...
minetest.register_node("angledwalls:low_angled_wall_" .. subname, {
	description = description,
	drawtype = "mesh",
...
minetest.register_craft({
	output = "angledwalls:low_angled_wall_" .. subname.." 2",
	recipe = {
		{"angledwalls:angled_wall_" .. subname}
	}
})

minetest.register_craft({
	output = "angledwalls:angled_wall_" .. subname,
	type = "shapeless",
	recipe = {
		"angledwalls:low_angled_wall_" .. subname, "angledwalls:low_angled_wall_" .. subname,
	}
})
end
...
function angledwalls.register_corner(subname, recipeitem, groups, images, description, sounds)
	groups.corner = 1
minetest.register_node("angledwalls:corner_" .. subname, {
	description = description,
	drawtype = "mesh",
...
minetest.register_craft({
	output = "angledwalls:corner_" .. subname.." 4",
	recipe = {
...
angledwalls.register_angled_wall_and_low_angled_wall_and_corner("meseblock", "default:mese",
		{cracky = 1, level = 2},
...
angledwalls.register_angled_wall_and_low_angled_wall_and_corner("desertcobble", "default:desertcobble",
		{cracky = 2, stone = 1},
