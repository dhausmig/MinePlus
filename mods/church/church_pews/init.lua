...
--		clicker:set_physics_override(1, 1, 1)
		playerphysics.remove_physics_factor(clicker, "speed", "church_speed")
		playerphysics.remove_physics_factor(clicker, "jump", "church_jump")
		playerphysics.remove_physics_factor(clicker, "gravity", "church_grav")
...
--		clicker:set_physics_override(0, 0, 0)
		playerphysics.add_physics_factor(clicker, "speed", "church_speed", 0)
		playerphysics.add_physics_factor(clicker, "jump", "church_jump", 0)
		playerphysics.add_physics_factor(clicker, "gravity", "church_grav", 0)
		clicker:setpos(pos)
